About pygelf-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pygelf-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5218&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pygelf-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pygelf` can be installed with `conda`:
...
```
mamba install pygelf
```

It is possible to list all of the versions of `pygelf` available on your platform with `conda`:
...
```
mamba search pygelf --channel conda-forge
```
...
mamba repoquery search pygelf --channel conda-forge

# List packages depending on `pygelf`:
mamba repoquery whoneeds pygelf --channel conda-forge

# List dependencies of `pygelf`:
mamba repoquery depends pygelf --channel conda-forge
```
